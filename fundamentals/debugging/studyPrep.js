/*
We make a few purchases to prepare for our study session, but the amount charged upon checkout seems too high. 
...
updateCart('pencil', 0); // amount = 0 || 1  sets amount = 1 since 0 evaluates to false
