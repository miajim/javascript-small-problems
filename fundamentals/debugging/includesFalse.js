/*
Caroline has written a very simple function, includesFalse, 
that searches a list of primitives for the boolean false. 
If false is found, the function immediately returns true. 
If no occurrence of false has been found after iterating through the entire array, 
...
function includesFalse(list) {
  for (let i = 0; i < list.length; i++) {
    ...
    if (element === false) { // must use strict equality comparison so that falsey values arent coerced to false
      return true;
    }
  }
