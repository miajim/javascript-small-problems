...
of text as arguments, and returns the text with every instance of the word
highlighted. To highlight a word, enclose the word with two asterisks ('**')
on each side and change every letter of the word to uppercase
(e.g., '**HIGHLIGHTEDWORD**').
*/


function searchWord(word, text) {
  return text.replace(new RegExp(`\\b${word}\\b`, 'ig'), `**${word.toUpperCase()}**`);
}
